package io.github.shaquibbai.deadlinedash.assets;

/**
 * Constants for game asset file paths.
 */
public class AssetPaths {
    public static final String MAP_IUT_CAMPUS = "maps/IUTshaqs.tmx";
    public static final String MAP_CAFE_INSIDE = "maps/CafeInside.tmx";
    ...
    public static final String QUEST_2 = "quests/quest2.json";
    public static final String ENDING_SCENE_IMAGE = "ending_scene.jpg";
}
